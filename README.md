...
当然，好的学习过程不仅需要你的实践，也需要沟通和交流，所以也欢迎你在 [Issues](https://github.com/lagoufed/fed-e-readme/issues) 中留言跟大家分享你的学习感悟，以及成长过程中的经验与成就。
...
- Node.js 环境
  - 推荐安装最新 LTS 版本，截至目前，最新的 LTS 版本是 [v12.18.2](https://nodejs.org/dist/v12.18.2/)
...
如果你有什么好的意见和建议，可以随时通过 [Issues](https://github.com/lagoufed/fed-e-readme/issues) 提出。
